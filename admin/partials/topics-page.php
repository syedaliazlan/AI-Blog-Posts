...
<div class="wrap ai-blog-posts-wrap">
	...
	<div class="ai-blog-posts-topics">
		...
		<!-- Bulk Actions (Top) -->
		<div class="topics-actions topics-actions-top">
			<div class="actions-left">
				<select id="bulk-action" class="bulk-action-selector">
				...
				<button type="button" id="apply-bulk" class="button apply-bulk-button">
		...
		<!-- Bulk Actions (Bottom) -->
		<div class="topics-actions topics-actions-bottom">
			<div class="actions-left">
				<select id="bulk-action-bottom" class="bulk-action-selector">
					<option value=""><?php esc_html_e( 'Bulk Actions', 'ai-blog-posts' ); ?></option>
					<option value="delete"><?php esc_html_e( 'Delete', 'ai-blog-posts' ); ?></option>
					<option value="generate"><?php esc_html_e( 'Generate Now', 'ai-blog-posts' ); ?></option>
				</select>
				<button type="button" id="apply-bulk-bottom" class="button apply-bulk-button">
					<?php esc_html_e( 'Apply', 'ai-blog-posts' ); ?>
				</button>
			</div>
		</div>
