				...
				<div class="form-section">
					...
					<div class="form-row">
						...
						<div class="form-field half">
							...
							<p class="description"><?php esc_html_e( 'Automatically search and embed relevant Pexels images in your blog post. GPT-5.2 will suggest images based on content context.', 'ai-blog-posts' ); ?></p>
						</div>
					</div>
				</div>
