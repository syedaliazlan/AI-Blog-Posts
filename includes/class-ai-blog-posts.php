...
class Ai_Blog_Posts {
	...
	private function load_dependencies() {
		 ...
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-ai-blog-posts-pexels.php';
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'wp_ajax_ai_blog_posts_verify_pexels_api_key', $plugin_admin, 'ajax_verify_pexels_api_key' );
