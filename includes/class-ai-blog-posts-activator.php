...
class Ai_Blog_Posts_Activator {
	...
	private static function set_default_options() {
		$defaults = array(
			...
			'ai_blog_posts_image_size'         => '1024x1024', // Smaller size for faster processing and smaller files
			'ai_blog_posts_image_quality'      => 'standard', // Standard quality for smaller files and faster processing
	 ...
	 *
	 * Simplified - no automated scheduling. Generation is manual only.
	 *
	 * @since    1.0.0
	 */
	private static function schedule_cron_events() {
		...
		wp_clear_scheduled_hook( 'ai_blog_posts_watchdog' );
		wp_clear_scheduled_hook( 'ai_blog_posts_trending_refresh' );
		wp_clear_scheduled_hook( 'ai_blog_posts_async_generation' );
	}
}
