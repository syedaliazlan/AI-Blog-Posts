...
// Prevent double-loading if plugin exists in multiple directories
// This can happen if the zip extracts to a different folder name (e.g., AI-Blog-Posts-main)
if ( defined( 'AI_BLOG_POSTS_VERSION' ) ) {
	// Plugin is already loaded from another directory, prevent redeclaration
	return;
}
 ...
 */
define( 'AI_BLOG_POSTS_VERSION', '1.2.8' );
